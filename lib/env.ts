...
export function validatePublicEnv() {
  ...
  return {
    ...
    revenueCatSixDayEntitlementId: process.env.EXPO_PUBLIC_RC_6_DAY_ENTITLEMENT_ID ?? 'six_day_control',
    revenueCatNinetyDayEntitlementId: process.env.EXPO_PUBLIC_RC_90_DAY_ENTITLEMENT_ID ?? 'ninety_day_quit',
    ...
    revenueCatSixDayProductIds: parseCsvEnv(process.env.EXPO_PUBLIC_RC_6_DAY_PRODUCT_IDS ?? 'six_day_control'),
    revenueCatNinetyDayProductIds: parseCsvEnv(process.env.EXPO_PUBLIC_RC_90_DAY_PRODUCT_IDS ?? 'ninety_day_quit'),
