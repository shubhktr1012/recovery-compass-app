...
export const REVENUECAT_CATALOG = createRevenueCatCatalog({
  ...
  smokingAlcoholQuitEntitlementId: env.revenueCatSmokingAlcoholQuitEntitlementId,
  smokingAlcoholQuitProductIds: env.revenueCatSmokingAlcoholQuitProductIds,
  gutHealthResetEntitlementId: env.revenueCatGutHealthResetEntitlementId,
  gutHealthResetProductIds: env.revenueCatGutHealthResetProductIds,
