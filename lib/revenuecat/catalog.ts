...
export function createRevenueCatCatalog(input: RevenueCatCatalogInput = {}): RevenueCatProgramDefinition[] {
  return [
    ...
    },
    {
      ...
      displayName: '14-Day Energy Reset',
      ...
      searchTokens: normalizeList(['energy', 'vitality', 'energy reset', '14-day']),
      legacyTier: 'full',
    },
    {
      programSlug: 'male_sexual_health',
      displayName: '30-Day Vitality',
      ...
      searchTokens: normalizeList(['male', 'vitality', 'sexual health', '30-day']),
      legacyTier: 'full',
    },
  ];
}
