  ...
  return (
    ...
    >
      <View className="bg-forest px-5 pt-5 pb-4 relative overflow-hidden">
        ...
        <View className="self-start flex-row items-center bg-sage/20 border border-sage/30 rounded-full px-2.5 py-1 mb-2.5 relative z-10">
          <Text className="font-satoshi text-[10px] font-medium text-sage/75 tracking-[0.1em] uppercase">Day {currentDayNumber} · {programName}</Text>
        </View>
        <Text className="font-erode-medium text-[22px] text-white leading-tight tracking-[-0.01em] relative z-10">
          {dayTitle}
        </Text>
        <Text className="font-satoshi text-xs text-white/60 mt-1.5 leading-relaxed relative z-10">
          {dayPreview}
        </Text>
      </View>
      <View className="p-4 px-5">
        <View className="flex-row items-center justify-between">
          <View className="flex-row items-center gap-1.5">
            ...
            <Text className="font-satoshi text-xs text-forest/45">{estimatedMinutes} min session</Text>
          </View>
          <View className="flex-row items-center gap-2 bg-forest rounded-full px-4 py-2.5 shadow-sm shadow-forest/20">
            ...
            <Text className="font-satoshi-medium text-[13px] text-white tracking-[-0.005em]">Open Today</Text>
          </View>
        </View>
      </View>
    </Pressable>
